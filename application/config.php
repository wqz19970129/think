...
return  [
    ...
    'picture_upload' => array(
            ...
            'rootPath' => './static/uploads/picture/', //保存根路径
    ...
    'download_upload' => array(
            ...
            'rootPath' => './static/uploads/download/', //保存根路径
            'saveName' => 'date', //上传文件命名规则 date   md5      sha1
            'replace'  => false, //存在同名是否覆盖
    ),
	// +----------------------------------------------------------------------
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '.:>L"#7I_hoRw4,@$Gmely|[u+jzNY<dg)An;aSP', //默认数据加密KEY
	'data_cache_key'=> '.:>L"#7I_hoRw4,@$Gmely|[u+jzNY<dg)An;aSP',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'.:>L"#7I_hoRw4,@$Gmely|[u+jzNY<dg)An;aSP', //加密KEY
