<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"E:\www\think\addons/editorforadmin\content.html";i:1496373782;}*/ ?>
<?php switch($addons_config['editor_type']): case "1": ?>
	...
	<?php break; case "2": ?>
		...
		<?php if($addons_config['editor_wysiwyg'] == '1'): ?>
			<link rel="stylesheet" href="__STATIC__/static/kindeditor/default/default.css" />
			<script charset="utf-8" src="__STATIC__/static/kindeditor/kindeditor-min.js"></script>
			<script charset="utf-8" src="__STATIC__/static/kindeditor/zh_CN.js"></script>
			<script type="text/javascript">
				...
				KindEditor.ready(function(K) {
					editor_<?php echo $addons_data['name']; ?> = K.create('textarea[name="<?php echo $addons_data['name']; ?>"]', {
						...
						//uploadJson : '<?php echo url('uploadJson'); ?>' }
		...
		<?php else: ?>
			<script type="text/javascript" charset="utf-8" src="__STATIC__/static/ueditor/ueditor.config.js"></script>
			<script type="text/javascript" charset="utf-8" src="__STATIC__/static/ueditor/ueditor.all.js"></script>
			<script type="text/javascript" charset="utf-8" src="__STATIC__/static/ueditor/lang/zh-cn/zh-cn.js"></script>
			<script type="text/javascript">
		...
		<script type="text/javascript" src="__STATIC__/static/jquery-migrate-1.2.1.min.js"></script>
		<script charset="utf-8" src="__STATIC__/static/xheditor/xheditor-1.2.1.min.js"></script>
		<script charset="utf-8" src="__STATIC__/static/xheditor/xheditor_lang/zh-cn.js"></script>
		<script type="text/javascript" src="__STATIC__/static/xheditor/xheditor_plugins/ubb.js"></script>
		<script type="text/javascript">
	...
	<?php break; case "4": ?>
		...
		<link rel="stylesheet" href="__STATIC__/static/thinkeditor/skin/default/style.css">
		<script type="text/javascript" src="__STATIC__/static/jquery-migrate-1.2.1.min.js"></script>
		<script type="text/javascript" src="__STATIC__/static/thinkeditor/jquery.thinkeditor.js"></script>
		<script type="text/javascript">
			$(function(){
				$('textarea[name="<?php echo $addons_data['name']; ?>"]').attr('id', 'editor_id_<?php echo $addons_data['name']; ?>');
				var options = {
