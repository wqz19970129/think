<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\www\think\public/../application/admin/view/default/house\edit.html";i:1526465323;s:70:"E:\www\think\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		<div class="form-item">
			<label class="item-label">租售标题<span class="check-tips"></span></label>
			<div class="controls">
		...
		<!--<div class="form-item">
			<label class="item-label">保修时间<span class="check-tips"></span></label>
			<div class="controls">
				<input type="date" class="text input-large" name="create_time" value="<?php echo (isset($info['create_time']) && ($info['create_time'] !== '')?$info['create_time']:''); ?>"><br>
				<input type="time" class="text input-large" name="his" value="<?php echo (isset($info['his']) && ($info['his'] !== '')?$info['his']:''); ?>">
			</div>
		</div>-->
		<div class="form-item">
